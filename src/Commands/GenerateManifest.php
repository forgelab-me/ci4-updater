...
class GenerateManifest extends BaseCommand
{
    ...
    public function run(array $params): void
    {
        ...
        $this->createReleaseZip($zipPath, $manifestPath, $scanDirs);
        ...
        CLI::write('  2. Attach ' . basename($zipPath) . ' as a release asset (it embeds manifest.json)', 'white');
    }

    private function createReleaseZip(string $zipPath, string $manifestPath, array $scanDirs): void
    {
        $zip = new \ZipArchive();
